...
#define PROGRAM_NAME    "Monocle PTZ Controller - IR Remote (ESP32)"
...
void setup() {
  ...
  // NOTE: do this after the WiFi connection has already been established, else the ESP32 may crash!
  irrecv.enableIRIn();
}
